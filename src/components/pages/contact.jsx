    ...
    return (
      <div className=" mx-auto h-screen">
        ...
        <div className=" mx-auto ">
          <h1 className="mt-4 font-bold text-center text-2xl underline ">
            {" "}
            Our Location in Google Map
          </h1>
          <h3 className="mb-4 text-center ">Feel to visit us</h3>
          <iframe
        ...
        <div className="my-4 w-7/12 mx-auto">
          ...
          <div className="mt-8 grid grid-cols-2 gap-8 py-2">
            <input
              className="border border-gray-700 px-4 py-2 outline-none"
              type="text"
